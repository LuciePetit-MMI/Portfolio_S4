        ...
        <header class="tablet:relative w-full">
            <div v-for="about in about" :key="about.id">
                <div class="pt-40 h-screen relative flex justify-center items-baseline">
                    ...
                    <a href="#main" class="absolute bottom-10 font-Indie text-xl tablet:left-10 tablet:bottom-20 laptop:bottom-60"><i class="fa fa-solid fa-arrow-down-long pr-4 animate-bounce"></i>Découvrir</a>  
                </div>
                    ...
                    <flickity class="main-carousel" ref="flickity" :options="flickityOptions">
                        <div v-for="projet in projects.details" :key="projet.id" class="carousel-cell">
                            <div class="h-96 overflow-hidden flex justify-center items-center relative">
                                ...
                                <button class="btn absolute bottom-10" @click="openProject(projet, projet.type)" >Voir plus</button>
                            </div>
                        </div>
                    </flickity>
                </div>
                <div id="desktop" class="hidden tablet:grid tablet:grid-cols-4 tablet:gap-4 tablet:mx-auto">
                    <div v-for="(projet, index) in projects.details" :key="index" v-if="index<5" class="relative cursor-pointer">
                        ...
                        <div class="opacity-0 hover:opacity-100 flex h-40 w-full bg-dark bg-opacity-70 absolute top-0 left-0 flex-col justify-center items-center laptop:h-60">
                            <h4>{{projet.title}}</h4>
                            <button @click="openProject(projet, projet.type)" class="btn">Voir plus</button>
                        </div>
                    </div>
                    <div class="overflow-hidden flex flex-col justify-center items-center h-40 w-full laptop:h-60">
                        <h2>{{projects.title}}</h2>
                    ...
                    <div v-show="currentProjet.type=='site'" class="z-50 py-10 w-full bg-dark bg-opacity-90 absolute top-0 left-0 px-4 laptop:px-6">
                        ...
                        <div class="flex flex-col">
                            <div class="flex flex-col text-left">
                                ...
                                <a :href="currentProjet.lien" target="blank" class="btn text-center self-center">Voir le site</a>
                            </div> 
                        </div>
                        ...
                        <div class="flex flex-col tablet:flex-row tablet:justify-evenly items-center">
                            <div class="flex flex-col text-left tablet:w-80 laptop:w-2/6">
                                ...
                                <div class="flex justify-evenly w-full">
                                    <a :href="currentProjet.maquette" target="blank" class="btn text-center self-center my-4">Maquette</a>
                                    <a v-show="currentProjet.dossier" :href="currentProjet.dossier" target="blank" class="btn text-center self-center my-4">Dossier</a>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col">
                            <div class="flex flex-col tablet:flex-row text-left tablet:justify-between">
                                <div class="w-3/4">
                                    ...
                                    <div class="flex justify-evenly w-full">
                                        <a :href="currentProjet.maquette" target="blank"  class="btn text-center self-center my-4">Maquette</a>
                                        <a :href="currentProjet.lien" target="blank"  class="btn text-center self-center my-4">Voir le site</a>
                                    </div>                            
                                </div>
                                <div class="flex flex-col">
                                    <h5>What I used</h5>
                        ...
                        <div  v-for="photo in photos.details" :key="photo.id" class="carousel-cell">
                            <div class="h-96 overflow-hidden flex justify-center items-center relative">
                                <img class="object-cover h-full w-full" :src="photo.urlImage" :alt="photo.altImage">
                                    <button class="btn absolute bottom-10" @click="currentPic(photo.urlImage, photo.altImage, 'photo')">Voir</button>
                            </div>
                        </div>
                    </flickity>
                </div>
                    ...
                    <flickity class="main-carousel" ref="flickity" :options="flickityOptions">
                        <div v-for="illustration in illustrations.details" :key="illustration.id" class="swiper-slide">
                            <div class="h-96 overflow-hidden flex justify-center items-center relative">
                                ...
                                <button class="btn absolute bottom-10" @click="currentPic(illustration.urlImage, illustration.altImage, 'illu')">Voir</button>
                            </div>
                        </div>
                    </flickity>  
                </div>
...
export default {
    ...
    //liste projets
        axios({
            method: 'get',
            url : param.hostSpe+"listWebdesignsAllFR",
        }).then(response=>{
    ...
    //list Illustrations
        axios({
            method: 'get',
            url : param.hostSpe+"listIllustrationsFR",
        }).then(response=>{
    ...
    //list Photos
        axios({
            method: 'get',
            url : param.hostSpe+"listPhotosFR",
        }).then(response=>{
    ...
    //list Contact
        axios({
            method: 'get',
            url : param.hostSpe+"listContactFR",
        }).then(response=>{
    ...
    //list Footer
        axios({
            method: 'get',
            url : param.hostSpe+"listFooterFR",
        }).then(response=>{
